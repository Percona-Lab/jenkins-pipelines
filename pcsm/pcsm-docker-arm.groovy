        ...
        stage ('Build image') {
            steps {
                sh """
                    ...
                    docker buildx build --provenance=false --sbom=false --load -t percona-clustersync-mongodb -f Dockerfile.aarch64 .
                """
            }
        }
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'hub.docker.com', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
                     sh """
                         ...
                         docker tag percona-clustersync-mongodb perconalab/percona-clustersync-mongodb:\$TAG-arm64
                         docker push perconalab/percona-clustersync-mongodb:\$TAG-arm64

                         docker manifest create perconalab/percona-clustersync-mongodb:\$TAG \
                            perconalab/percona-clustersync-mongodb:\$TAG-amd64 \
                            perconalab/percona-clustersync-mongodb:\$TAG-arm64
                         docker manifest annotate perconalab/percona-clustersync-mongodb:\$TAG \
                            perconalab/percona-clustersync-mongodb:\$TAG-arm64 --os linux --arch arm64 --variant v8
                         docker manifest annotate perconalab/percona-clustersync-mongodb:\$TAG \
                            perconalab/percona-clustersync-mongodb:\$TAG-amd64 --os linux --arch amd64
                         docker manifest inspect perconalab/percona-clustersync-mongodb:\$TAG
                         docker manifest push perconalab/percona-clustersync-mongodb:\$TAG
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'hub.docker.com', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
                     sh """
                         ...
                         docker tag percona-clustersync-mongodb percona/percona-clustersync-mongodb:\$TAG-arm64
                         docker push percona/percona-clustersync-mongodb:\$TAG-arm64

                         docker manifest create percona/percona-clustersync-mongodb:\$TAG \
                            percona/percona-clustersync-mongodb:\$TAG-amd64 \
                            percona/percona-clustersync-mongodb:\$TAG-arm64
                         docker manifest annotate percona/percona-clustersync-mongodb:\$TAG \
                            percona/percona-clustersync-mongodb:\$TAG-arm64 --os linux --arch arm64 --variant v8
                         docker manifest annotate percona/percona-clustersync-mongodb:\$TAG \
                            percona/percona-clustersync-mongodb:\$TAG-amd64 --os linux --arch amd64
                         docker manifest inspect percona/percona-clustersync-mongodb:\$TAG
                         docker manifest push percona/percona-clustersync-mongodb:\$TAG
