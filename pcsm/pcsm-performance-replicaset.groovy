        ...
        always {
            ...
            script {
                if (params.DESTROY || stageFailed) {
                    ...
                    echo "########################################################### NOTE ##########################################################\n" +
                            "To access PMM to see performance stats, run the following command: 'ssh -L 8443:127.0.0.1:443 <SSH-USER>@<AWS-CLUSTERSYNC-IP>'\n" +
                            "The IP address for ClusterSync can be found in this Jenkins log under the 'TASK [Wait for SSH]' section.\n" +
