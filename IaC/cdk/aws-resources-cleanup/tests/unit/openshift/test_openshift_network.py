...
from aws_resource_cleanup.openshift.network import (
    delete_nat_gateways,
    release_elastic_ips,
...
class TestDeleteNatGateways:
    ...
    @patch("aws_resource_cleanup.openshift.network.boto3.client")
    @patch("aws_resource_cleanup.openshift.network.DRY_RUN", False)
    ...
    @patch("aws_resource_cleanup.openshift.network.boto3.client")
    @patch("aws_resource_cleanup.openshift.network.DRY_RUN", True)
