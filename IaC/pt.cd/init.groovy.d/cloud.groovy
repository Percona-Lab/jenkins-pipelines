...
netMap = [:]
netMap['us-west-2a'] = 'subnet-034937138c803b01c'
netMap['us-west-2b'] = 'subnet-011fce55b4058aa92'
netMap['us-west-2c'] = 'subnet-07b70edbf3bec69af'
...
SlaveTemplate getTemplate(String OSType, String AZ) {
    return new SlaveTemplate(
        ...
        [
            new EC2Tag('Name', 'jenkins-pt-' + OSType),
...
String sshKeysCredentialsId = '6ec68b73-be5a-4422-ba1c-41e4be07d55a'
