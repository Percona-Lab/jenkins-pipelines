...
void buildStage(String DOCKER_OS, String STAGE_PARAM) {
    sh """
        ...
        cd debs
        wget https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/libperconaserverclient21-dev_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/libperconaserverclient21_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/percona-mysql-router-zenfs_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/percona-server-client-zenfs_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/percona-server-common-zenfs_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/percona-server-dbg-zenfs_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/percona-server-rocksdb-zenfs_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/percona-server-server-zenfs_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/percona-server-source-zenfs_8.0.25-15-2.hirsute_amd64.deb https://downloads.percona.com/downloads/TESTING/issue-CUSTOM83_1/percona-server-test-zenfs_8.0.25-15-2.hirsute_amd64.deb
...
￼           sudo rmdir /sys/kernel/config/nullb/nullb\$nulldevice || true
        ...
        sudo chmod 777 mysql-test-run.pl
