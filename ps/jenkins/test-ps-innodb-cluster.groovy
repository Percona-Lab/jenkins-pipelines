library changelog: false, identifier: 'lib@fix-pkg', retriever: modernSCM([
    $class: 'GitSCMSource',
...
void installDependencies() {
    sh """
        ...
        python3 -m pip install --upgrade PyYaml==5.3.1 molecule==25.12.0 testinfra pytest molecule-ec2==0.3 molecule[ansible] "ansible<10.0.0" "ansible-lint>=5.1.1,<6.0.0" boto3 boto
