...
pipeline {
    ...
    parameters {
        ...
        int(name: 'PML_USE_COLLECTION_BULK_WRITE',description: 'Determines whether to use the Collection Bulk Write API',defaultValue: 1)
        int(name: 'PML_CLONE_NUM_PARALLEL_COLLECTIONS',description: 'The number of collections cloned in parallel during the clone process',defaultValue: 0)
        int(name: 'PML_CLONE_NUM_READ_WORKERS',description: 'The number of read workers used during the clone',defaultValue: 0)
        int(name: 'PML_CLONE_NUM_INSERT_WORKERS',description: 'The number of insert workers used during the clone',defaultValue: 0)
        int(name: 'PML_CLONE_SEGMENT_SIZE',description: 'The segment size in bytes used during the clone',defaultValue: 0)
        int(name: 'PML_CLONE_READ_BATCH_SIZE',description: 'The read batch size in bytes used during the clone',defaultValue: 0)
        int(name: 'PML_DEV_TARGET_CLIENT_COMPRESSORS',description: 'The read batch size in bytes used during the clone')
