...
def moleculeDir = "pml-functional/manual"
...
pipeline {
    ...
    parameters {
        ...
        choice(name: 'LAYOUT',description: 'Layout',choices: ['replicaset','sharded','manual/aws'])
