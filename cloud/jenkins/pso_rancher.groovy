...
pipeline {
    ...
    parameters {
        ...
        choice(name: 'PILLAR_VERSION', choices: ['none', '97', '84', '80'], description: 'Set to 80/84/97 for a release run. Release runs force PLATFORM_CHANNEL=stable and load images from source/e2e-tests/release_versions.')
