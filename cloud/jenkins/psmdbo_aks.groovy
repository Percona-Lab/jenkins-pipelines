...
pipeline {
    ...
    parameters {
        ...
        string(name: 'PLATFORM_VERSION', defaultValue: 'latest', description: 'AKS kubernetes version. If set to min or max, value will be automatically taken from release_versions file.')
            ...
            steps {
                script {
                    testVariables = libraries.tests.prepareVersions([
                        ...
                        region                : AKS_LOCATION ?: libraries.azure.getLocation(JOB_NAME),
            ...
            script {
                ...
                clusters.each { clusterSuffix ->
                    try {
                        ...
                        libraries.azure.shutdownCluster(clusterCfg)
                    } catch (err) {
