...
pipeline {
    ...
    stages {
        stage("Run parallel") {
            parallel {
                ...
                stage('Trigger pgo-rancher-1 job 2 times') {
                    steps {
                        triggerJobMultiple("pgo-rancher-1")
                    }
                }
            }
        }
    ...
    post {
        always {
            ...
            copyArtifacts(projectName: 'pgo-rancher-1', selector: lastCompleted(), target: 'pgo-rancher-1')
