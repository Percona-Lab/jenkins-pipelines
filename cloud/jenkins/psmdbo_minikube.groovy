...
pipeline {
    ...
    parameters {
        ...
        string(name: 'PLATFORM_VERSION', defaultValue: 'latest', description: 'Minikube kubernetes version. If set to rel, value will be automatically taken from release_versions file.')
