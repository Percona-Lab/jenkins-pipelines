...
void  generateImageSummary(filePath) {
    ...
    def report = "### Image Summary Report\n\n"
    report += "Total Images: ${images.size()}\n\n"
    report += "#### Image List:\n"
    ...
    stages {
       ...
       stage('Snyk CVEs Check') {
            ...
            stage('Generate Report') {
                steps {
                    script {
                        ...
                        writeFile(file: 'image-summary.txt', text: summary)
            ...
            stage('Publish Report') {
                steps {
                    publishTextFile(file: 'image-summary.txt', title: 'Image Summary Report')
                }
            }
    }
