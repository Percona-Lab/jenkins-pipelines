// GENERATED by ppg-testing tools/gen_jenkins.py from pg_stat_monitor/pgsm_pgdg/scenario.yml -- do not edit
        ...
        stage('Prepare') {
            steps {
                script {
                    ...
                    sh "python3 tools/render.py --group pg_stat_monitor/pgsm_pgdg"
                }
            }
        }
