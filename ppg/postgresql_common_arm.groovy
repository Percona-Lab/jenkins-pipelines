...
void buildStage(String DOCKER_OS, String STAGE_PARAM) {
    sh """
        set -o xtrace
        mkdir test
        wget \$(echo ${GIT_REPO} | sed -re 's|github.com|raw.githubusercontent.com|; s|\\.git\$||')/${GIT_BRANCH}/postgres-common/ppg-common_builder.sh -O ppg-server_builder.sh
        pwd -P
        ls -laR
...
pipeline {
    ...
    parameters {
        ...
        string(
            defaultValue: '256',
            description: 'Tag/Branch for postgresql-common',
            name: 'PG_BRANCH')
        string(
            defaultValue: '16.1',
