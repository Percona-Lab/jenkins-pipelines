        ...
        stage ('Build image') {
            steps {
                sh """
                    ...
                    docker build --no-cache . -t percona-distribution-postgresql -f Dockerfile.aarch64
                    docker build --no-cache . -t percona-distribution-postgresql-with-postgis -f Dockerfile-postgis.aarch64
                    """
            }
        }
