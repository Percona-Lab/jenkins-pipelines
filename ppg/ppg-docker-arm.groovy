        ...
        stage ('Build image') {
            steps {
                sh """
                    ...
                    docker build --platform=linux/arm64 --no-cache --provenance=false -t percona-distribution-postgresql -f Dockerfile.aarch64 .
                    docker build --platform=linux/arm64 --no-cache --provenance=false -t percona-distribution-postgresql-with-postgis -f Dockerfile-postgis.aarch64 .
                    """
            }
        }
