        ...
        stage ('Build image') {
            steps {
                sh """
                    ...
                    DOCKER_BUILDKIT=1 docker build --platform=linux/arm64 --no-cache --provenance=false -t percona-distribution-postgresql -f Dockerfile.aarch64 .
                    DOCKER_BUILDKIT=1 docker build --platform=linux/arm64 --no-cache --provenance=false -t percona-distribution-postgresql-with-postgis -f Dockerfile-postgis.aarch64 .
                    """
            }
        }
