library changelog: false, identifier: 'lib@DISTPG-465_add_ppg-server_pipeline', retriever: modernSCM([
    $class: 'GitSCMSource',
...
pipeline {
    ...
    parameters {
        string(
            defaultValue: 'https://github.com/surbhat1595/postgres-packaging.git',
