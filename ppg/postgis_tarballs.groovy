                ...
                stage('Build postgis-tarball for OL8 amd64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_EL8_AMD64} > uploadPath-${PG_VERSION}
                ...
                stage('Build postgis-tarball for OL8 arm64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_EL8_ARM64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for OL9 amd64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_EL9_AMD64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for OL9 arm64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_EL9_ARM64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Ubuntu focal amd64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_FOCAL_AMD64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Ubuntu focal arm64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_FOCAL_ARM64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Ubuntu jammy amd64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_JAMMY_AMD64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Ubuntu jammy arm64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_JAMMY_ARM64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Ubuntu noble amd64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_NOBLE_AMD64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Ubuntu noble arm64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_NOBLE_ARM64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Debian bullseye amd64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_BULLSEYE_AMD64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Debian bullseye arm64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_BULLSEYE_ARM64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Debian bookworm amd64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_BOOKWORM_AMD64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
                ...
                stage('Build postgis-tarball for Debian bookworm arm64') {
                    ...
                    steps {
                        ...
                        script {
                                ...
                                sh """
                                        echo ${AWS_STASH_PATH_BOOKWORM_ARM64} > uploadPath-${PG_VERSION}
                                        cat uploadPath-${PG_VERSION}
                                """
                                stash includes: "uploadPath-${PG_VERSION}", name: "uploadPath-${PG_VERSION}"
