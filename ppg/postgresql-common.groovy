...
void buildStage(String DOCKER_OS, String STAGE_PARAM) {
    sh """
        set -o xtrace
        mkdir test
        wget \$(echo ${GIT_REPO} | sed -re 's|github.com|raw.githubusercontent.com|; s|\\.git\$||')/${GIT_BRANCH}/postgres-common/ppg-common_builder.sh -O builder.sh
...
pipeline {
    ...
    parameters {
        ...
        string(
            ...
            description: 'URL for postgresql-common repository',
            name: 'GIT_REPO')
        string(
            defaultValue: 'debian/256',
            description: 'Tag/Branch for postgresql-common repository',
            name: 'PG_BRANCH')
        string(
            defaultValue: '16.0',
            description: 'Tag/Branch for postgresql-common packaging repository',
            name: 'GIT_BRANCH')
        string(
            defaultValue: '1',
    ...
    stages {
        stage('Create postgresql-common source tarball') {
            steps {
