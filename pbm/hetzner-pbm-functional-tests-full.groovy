                        ...
                        steps {
                            ...
                            file(credentialsId: 'PBM-OSS-EU', variable: 'PBM_OSS_YML')]) {
                                ...
                                sh """
                                    ...
                                    docker compose up -d
                                    KMS_ID="${KMS_ID}" docker compose run test pytest -s test_PBM-1683.py --junitxml=junit.xml --shard-id=${SHARD} --num-shards=10 \$JENKINS_FLAG ${params.PYTEST_PARAMS} || true
