                        ...
                        ssh -i "${KEY_PATH}" -o ConnectTimeout=1 -o StrictHostKeyChecking=no ${USER}@\$(cat IP) "
                            ...
                            if [[ \$CLIENT_VERSION = dev-latest ]]; then
                                ...
                                if [[ \$CLIENT_VERSION == http* ]]; then
                                    ...
                                    wget -O pmm2-client.tar.gz --progress=dot:giga "https://www.percona.com/downloads/pmm-client/pmm-client-\${CLIENT_VERSION}/binary/tarball/pmm-client-\${CLIENT_VERSION}.tar.gz"
                                fi
