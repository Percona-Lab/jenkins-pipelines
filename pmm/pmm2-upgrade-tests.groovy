        ...
        stage('Run UI way Upgrade Tests') {
            ...
            steps {
                withCredentials([aws(accessKeyVariable: 'BACKUP_LOCATION_ACCESS_KEY', credentialsId: 'BACKUP_E2E_TESTS', secretKeyVariable: 'BACKUP_LOCATION_SECRET_KEY'), aws(accessKeyVariable: 'AWS_ACCESS_KEY_ID', credentialsId: 'PMM_AWS_DEV', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY')]) {
                    ...
                    ./node_modules/.bin/codeceptjs run-multiple parallel --reporter mocha-junit-reporter -c pr.codecept.js --grep '@pmm-upgrade'
                    '''
                }
            }
        }
        stage('Run Docker Way Upgrade Tests') {
            ...
            steps {
                withCredentials([aws(accessKeyVariable: 'BACKUP_LOCATION_ACCESS_KEY', credentialsId: 'BACKUP_E2E_TESTS', secretKeyVariable: 'BACKUP_LOCATION_SECRET_KEY'), aws(accessKeyVariable: 'AWS_ACCESS_KEY_ID', credentialsId: 'PMM_AWS_DEV', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY')]) {
                    ...
                    export PWD=$(pwd)
                    export CHROMIUM_PATH=/usr/bin/chromium
                    ./node_modules/.bin/codeceptjs run-multiple parallel --reporter mocha-junit-reporter -c pr.codecept.js --grep '@pre-upgrade'
                '''
                    sh '''
                ...
                '''
                    ...
                    export CHROMIUM_PATH=/usr/bin/chromium
                    sleep 30
                    ./node_modules/.bin/codeceptjs run-multiple parallel --reporter mocha-junit-reporter -c pr.codecept.js --grep '@post-upgrade'
                '''
                }
            }
        }
        ...
        stage('Check Client Upgrade') {
            steps {
                ...
                sh '''
                    ...
                    export CHROMIUM_PATH=/usr/bin/chromium
                    sleep 60
                    ./node_modules/.bin/codeceptjs run --reporter mocha-junit-reporter -c pr.codecept.js --grep '@post-client-upgrade'
                '''
            }
        }
    }
