        ...
        stage('Publish Docker image') {
            ...
            steps {
                ...
                sh """
                    ...
                    scp -i ~/.ssh/id_rsa_downloads -P 2222 pmm-server-\${VERSION}.docker pmm-server-\${VERSION}.md5sum jenkins@jenkins-deploy.jenkins-deploy.web.r.int.percona.com:/data/downloads/pmm2/\${VERSION}/docker/
                """
                deleteDir()
            }
        }
