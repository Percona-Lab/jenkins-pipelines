...
pipeline {
    ...
    environment {
        AZURE_CLIENT_ID=credentials('');
        AZURE_CLIENT_SECRET=credentials('');
        AZURE_MYSQL_HOST=credentials('');
        AZURE_MYSQL_PASS=credentials('');
        AZURE_MYSQL_USER=credentials('');
        AZURE_POSTGRES_HOST=credentials('');
        AZURE_POSTGRES_PASS=credentials('');
        AZURE_POSTGRES_USER=credentials('');
        AZURE_SUBSCRIPTION_ID=credentials('');
        AZURE_TENNANT_ID=credentials('');
