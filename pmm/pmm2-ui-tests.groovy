...
pipeline {
    ...
    environment {
        ...
        MAILOSAUR_API_KEY=credentials('mailosaur-api-key')
        MAILOSAUR_SERVER_ID=credentials('mailosaur-server-id')
        MAILOSAUR_SMTP_PASSWORD=credentials('mailosaur-smtp-password')
    }
    parameters {
        string(
