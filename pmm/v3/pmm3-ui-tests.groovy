...
pipeline {
    ...
    environment {
        ...
        REMOTE_AWS_MYSQL84_HOST=credentials('REMOTE_AWS_MYSQL84_HOST')
        REMOTE_AWS_MYSQL84_USER=credentials('REMOTE_AWS_MYSQL84_USER')
        REMOTE_AWS_MYSQL84_PASSWORD=credentials('REMOTE_AWS_MYSQL84_PASSWORD')
        ...
        PMM_QA_RDS_PGSQL13_DATABASE=credentials('PMM_QA_RDS_PGSQL13_DATABASE')
        ...
        PMM_QA_RDS_PGSQL14_DATABASE=credentials('PMM_QA_RDS_PGSQL14_DATABASE')
        ...
        PMM_QA_RDS_PGSQL15_DATABASE=credentials('PMM_QA_RDS_PGSQL15_DATABASE')
        ...
        PMM_QA_RDS_PGSQL16_DATABASE=credentials('PMM_QA_RDS_PGSQL16_DATABASE')
        ...
        PMM_QA_RDS_PGSQL17_DATABASE=credentials('PMM_QA_RDS_PGSQL17_DATABASE')
