            ...
            steps {
                ...
                script {
                    ...
                    if (params.DESTINATION == "testing") {
                        ...
                        env.DOCKER_BUILD_TAG = "${versionTag}-rc${BUILD_NUMBER}"
                    } else {
                ...
                withCredentials([usernamePassword(credentialsId: 'hub.docker.com', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
                    sh '''
                        ...
                        if [ -n "${DOCKER_RC_TAG}" ]; then
                            ...
                            docker buildx imagetools create -t perconalab/pmm-server:${DOCKER_BUILD_TAG} \
                                perconalab/pmm-server:${DOCKER_RC_TAG}-amd64 \
                                perconalab/pmm-server:${DOCKER_RC_TAG}-arm64
                            echo "${DOCKER_BUILD_TAG}" > DOCKER_TAG
                        else
