...
library changelog: false, identifier: 'lib@PMM-7-fetch-correct-pmm-client-verison', retriever: modernSCM([
    $class: 'GitSCMSource',
    remote: 'https://github.com/Percona-Lab/jenkins-pipelines.git'
]) _

library changelog: false, identifier: 'v3lib@PMM-7-fetch-correct-pmm-client-verison', retriever: modernSCM(
