            ...
            steps {
                script {
                    if (env.UPGRADE_FLAG == "SSL") {
                        ...
                        env.PMM_CLIENTS = "--database external --database ps=8.4 --database pdpgsql --database psmdb,SETUP_TYPE=pss,COMPOSE_PROFILES=extra --database pxc --database pgsql --database ssl_psmdb --database ssl_mysql --database ssl_pdpgsql"
