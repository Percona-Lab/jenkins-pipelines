...
pipeline {
    ...
    parameters {
        ...
        text(
            defaultValue: '--addclient=modb,1 --pgsql-version 16 --addclient=pgsql,1 --addclient=ps,1 --setup-with-custom-settings --setup-external-service --setup-ssl-services --mo-version "7.0" --mongo-replica-for-backup',
            description: '''
