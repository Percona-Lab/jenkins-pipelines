library changelog: false, identifier: 'lib@PMM-9242-arm-build-for-client', retriever: modernSCM([
    $class: 'GitSCMSource',
                    ...
                    steps {
                        ...
                        script {
                            ...
                            if (params.DESTINATION == "testing") {
                                ...
                                env.DOCKER_LATEST_TAG = "dev-latest-amd64"
                            }
                        }
                        ...
                        withCredentials([usernamePassword(credentialsId: 'hub.docker.com', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
                            withEnv(['PATH_TO_SCRIPTS=' + env.PATH_TO_SCRIPTS]) {
                                sh '''
                                    ...
                                    export DOCKER_CLIENT_TAG=perconalab/pmm-client-test:$(date -u '+%Y%m%d%H%M')-amd64
