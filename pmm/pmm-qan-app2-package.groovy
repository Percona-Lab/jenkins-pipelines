...
pipeline {
    ...
    parameters {
        string(
            defaultValue: 'angular2-migration',
    ...
    stages {
        ...
        stage('Build RPMs') {
            ...
            steps {
                ...
                sh 'mockchain -m --define="dist .el7" -c -r epel-7-x86_64 -l result-repo -a http://download.fedoraproject.org/pub/epel/testing/7/x86_64/ rhel/SRPMS/*.src.rpm'
