def call(String type='latest') {
  ...
  List<String> ovfVersions = ['2.37.0', '2.36.0', '2.35.0', '2.34.0', '2.33.0', '2.32.0', '2.31.0', '2.30.0', '2.29.1', '2.28.0', '2.27.0', '2.26.0', '2.25.0'];
  List<String> dbaasVersions = ['2.37.0', '2.36.0', '2.35.0', '2.34.0'];
