    ...
    withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', accessKeyVariable: 'AWS_ACCESS_KEY_ID', credentialsId: S3_STASH, secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]) {
        retry(15) {
	        ...
	        pwd
                ...
                AWS_RETRY_MODE=standard AWS_MAX_ATTEMPTS=10 aws s3 cp --recursive \$S3_PATH/${FOLDER_NAME} ${FOLDER_NAME} ${S3_FILTER} ${S3_ENDPOINT} --cli-connect-timeout 60 --cli-read-timeout 120
            """
        }
    }
}
