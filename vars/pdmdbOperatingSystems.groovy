def call(String version = 'default', String newVersion = null, String gatedBuild = 'false') {
    ...
    def switchValues = [
        ...
        (~/(p.mdb-)?6(\.)?0.*/): ['debian-11', 'rhel8', 'rhel9', 'ubuntu-jammy', 'ubuntu-noble', 'rhel8-arm', 'rhel9-arm', 'ubuntu-jammy-arm','ubuntu-noble-arm', 'al2023', 'al2023-arm','ubuntu-jammy-pro','ubuntu-noble-pro' ],
        (~/(p.mdb-)?7(\.)?0.*/): ['debian-11', 'debian-12', 'rhel8', 'rhel9', 'ubuntu-jammy', 'ubuntu-noble', 'rhel8-arm', 'rhel9-arm', 'ubuntu-jammy-arm', 'ubuntu-noble-arm', 'al2023', 'al2023-arm','ubuntu-jammy-pro','ubuntu-noble-pro' ],
        (~/(p.mdb-)?8(\.)?0.*/): ['debian-12', 'rhel8', 'rhel8-arm', 'rhel9', 'rhel9-arm', 'ubuntu-jammy', 'ubuntu-jammy-arm', 'ubuntu-noble', 'ubuntu-noble-arm', 'al2023', 'al2023-arm','ubuntu-jammy-pro','ubuntu-noble-pro'],
