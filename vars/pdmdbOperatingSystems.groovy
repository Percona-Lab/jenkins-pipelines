def call(String version = 'default', String newVersion = null) {
    def switchValues = [
        (~/(p.mdb-)?6(\.)?0.*/): ['centos-7', 'debian-11', 'ubuntu-focal', 'rhel8', 'rhel9', 'ubuntu-jammy', 'ubuntu-noble', 'rhel8-arm', 'rhel9-arm', 'ubuntu-focal-arm', 'ubuntu-jammy-arm','ubuntu-noble-arm' ],
